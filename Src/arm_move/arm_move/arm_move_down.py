...
def main():
    ...
    target_pose.pose.orientation.w =0.706929624080658  # unit quaternion (no rotation)
    target_pose.pose.position.x = 0.5134093165397644   # Replace with your desired X position  0.613124668598175    
    target_pose.pose.position.y = -0.11250433325767517 # Replace with your desired Y position   -0.11223892867565155
    target_pose.pose.position.z = 0.527624249458313  # Replace with your desired Z position
...
if __name__ == '__main__':
    main()   # Replace with your desired X position  0.613124668598175    
    target_pose.pose.position.y = -0.11223892867565155 # Replace with your desired Y position   -0.11223892867565155
    target_pose.pose.position.z = 0.6966144442558289  # Replace with your desired Z position
